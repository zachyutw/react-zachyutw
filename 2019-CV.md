...
- Frontend
	- PWA, RWD, FlexBox, Async AJAX Request, Animation, Transform, Grid
- Backend
	- NodeJS, NoSQL, SQL Database, GeoMap, SSL
...
- Project Scope: I used **react-native-client** to build a react-native prototype. The project goal would share more codes between ReactJS. 
- The application support complex **React-navigation** routing, **Material UI**, **firebase** authorization system, **firebase** database.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk3MzU3MjIzLDQ3ODI1OTMyNSwxODQ5OT
M2ODQ4LDE4NTk4MzUwMjVdfQ==
-->