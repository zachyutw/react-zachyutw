...
* The application using new application structure and new backend system. The application include responsive design,  post system,  e-commerce system, payment system, chat system, 
Skills: React, Mapbox, Stripe, Twilio, Weixin, Webhook, Nginx, Axios, React-Router, Lazy loading, Form-control, Semantic UI, Node, Express, Google-Map, i18next, Next-CSS, React-hook, React Context API, SEO.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDE0NzM3OTksLTEzMzI4NjU3OTEsLT
IwNzg0MDI5OF19
-->